...
$\bullet$ {\bf Schedule} \hspace{0.1in} NASA-funded Probe studies including PICO assume a Phase~A start in October 2023. PICO development phases B-D are similar in duration to recent comparably sized NASA missions such as Juno and SMAP. PICO is a cryogenic mission similar to \planck , but the cryogenic design is simpler because all PICO's bolometric detectors are maintained at 0.1~K (\planck 's bolometers were maintained at 0.1~K, and the radiometers at 20~K).  We used experience from \planck\ and from current implementations of ground-based kilo-pixel arrays  to allocate appropriate time and budget for integration and testing (I\&T) throughout all stages of the development; in most cases, significantly more time was provided in the schedule for I\&T compared to that allocated for \planck . 

The baseline mission lifetime is 5 years. The PICO instrument does not have cryogenic consumables (as Planck did), permitting mission extension beyond the prime mission duration. \comred{Mission extensions will be limited by availability of fuel for hydrazine thrusters.}
...
%\input tables/abridged_table6.1_wrap.tex
...
\cite{Mrozinski2017}, assuming a commercial build. Based on JPL experience, 18\,\% of the instrument cost is allocated for integration and testing (I\&T). More details on the cost of PICO are available in the full PICO report~\citep{picoreport_arxiv}.

% Amy's text below
%PICO's total development and operations cost is estimated to be between \$870M and \$960M (Table~\ref{tab:cost}). Estimates are based on the current PICO design, which is a robust Class~B architecture appropriate to this medium class mission. All appropriate flight spares, engineering models, and prototypes are included. The mission costs include \$19M for the science team during  development and \$20M during operations, based on science team workforce estimates informed by experience with the \planck mission. Pre-Phase-A technology maturation will be accomplished through the normal APRA and SAT processes, and is not included in the mission cost. The PICO Team estimates the total cost of the required technology maturation to be about \$13M. \comred{move this to the other section.}

%NASA commissioned Team~X (JPL's concurrent design facility) to estimate the PICO mission cost. The Team~X cost estimate was generated in October 2018 after a series of instrument and mission-level studies. Team~X estimates are generally model-based, and their accuracy is commensurate with the level of understanding typical to Pre-Phase-A concept development. 
