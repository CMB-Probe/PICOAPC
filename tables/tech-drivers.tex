...
\begin{table}
\caption{\captiontext 
  PICO technologies can be developed to TRL~5 prior to a 2023 Phase~A start using the APRA and SAT programs, requiring an estimated total of \$13M. \label{tab:technologies}}
\begingroup
%\openup 5pt
