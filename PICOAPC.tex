...
\subfile{extragalacticsci2_apc.tex}
...
\subsection{Foregrounds and Systematics}%  (4 pages)}
\label{sec:signal_separation}

\subfile{foregrounds-systematics-apc.tex}
